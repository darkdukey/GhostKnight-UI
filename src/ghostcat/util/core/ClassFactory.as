package ghostcat.util.core
{
	...
	{
		/**
		 * Class definition, can be String or Class
		 */
		public var generator : *;

		/**
		 * Initial properties for class
		 */
		public var properties : Object = null;
		
		/**
		 * Parameters going to be used for the constructor
		 */		
		...
		/**
		 * Create new instance with the parameters
		 *  
		 * @param generator
		 * @param args
		 * @return 
